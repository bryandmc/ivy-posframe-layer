...
;; added to `ivy-posframe-layer-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `ivy-posframe-layer/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `ivy-posframe-layer/pre-init-PACKAGE' and/or
;;   `ivy-posframe-layer/post-init-PACKAGE' to customize the package as it is loaded.
